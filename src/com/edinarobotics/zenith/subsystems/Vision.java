...
public class Vision extends Subsystem1816 {
	...
	public double calculateXSpeed() {
		double speed = -1.0 * ((calculateXYDistance()[0] / 380) * X_SPEED_COEFFICIENT);
	...
	public double calculateYTarget() {
		return -1.0 * ((calculateXYDistance()[0] / 240) * Y_TARGET_COEFFICIENT * Y_INCREMENT);
	}
